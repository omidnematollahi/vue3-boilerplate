<template>
  <div class="presenter">
    <h3 class="presenter__title">StepperInput Component Presentation</h3>
    <br />
    <div>
      <h4>Value ~ {{ value }}</h4>
      <p>
        Value must be between -50 and 50 (both included) and step is 10 (between
        numbers are valid)
      </p>
      <br />
      <i>
        Also not<span class="presenter__highlight">width</span>is set to the
        stepper
      </i>
    </div>
